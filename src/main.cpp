...
unsigned int nStakeCapAge = 60 * 60 * 24 * 15;    // 15 day interest cap
unsigned int nStakeTargetSpacing = 60;			// 60 sec block spacing

int64 nChainStartTime = 1407387082;
...
const string strMessageMagic = "SoniScrewdriver Signed Message:\n";
...
bool CTransaction::CheckTransaction() const
{
    ...
    // John Connor: https://github.com/ppcoin/ppcoin/pull/104/
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in StealthCoin
    bool fStrictPayToScriptHash = true; // Always active in StealthCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Sonic", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "The Doctor is Dead!!";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xb1cf6fbaf27f3cb5a1a3da914fe11060239a7df4424db8045e425f2e605f7320"));
