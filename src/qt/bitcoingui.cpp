    ...
    rpcConsole(0)
{
    ...
    bittrexWindow = new BittrexWindow(this);
    richlistWindow = new RichlistWindow(this);
    ...
    //    centralWidget->addWidget(statisticsPage);
        ...
        centralWidget->addWidget(bittrexWindow);
        centralWidget->addWidget(richlistWindow);
...
syncIconMovie = new QMovie(":/movies/spinner", "mng", this);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Sonic address"));
...
connect(overviewAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    ...
    connect(richlistAction, SIGNAL(triggered()), this, SLOT(gotoRichlistPage()));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About SonicCoin"), this);
    aboutAction->setToolTip(tr("Show information about SonicCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for SonicCoin"));
...
{
    QToolBar *toolbar = addToolBar(tr("Menu Bars"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("SonicCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("SonicCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sonic network.", "", count));
}
...
void BitcoinGUI::gotoOverviewPage()
{
    ...
    centralWidget->setCurrentWidget(overviewPage);
        centralWidget->setMaximumWidth(1080);
        centralWidget->setMaximumHeight(800);
...
void BitcoinGUI::gotoBittrexPage()
{
    ...
    centralWidget->setCurrentWidget(bittrexWindow);
...
void BitcoinGUI::gotoRichlistPage()
{
    ...
    centralWidget->setCurrentWidget(richlistWindow);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Sonic address or malformed URI parameters."));
    }
...
void BitcoinGUI::backupWallet()
{
    ...
    //QString saveDir = QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation); QT5
